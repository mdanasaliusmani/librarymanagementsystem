...
Step 8: Admin Login User Id: ```lcs2024054@iiitl.ac.in``` & Password: ```Jaijagat```


# Admin Login Interface

<img src="images/admin.png" alt="Admin Login Interface">

# Add new books, update books, view books, delete books

<img src="images/addbooks.png" alt="Books Management">

# Add new authors, update authors, view authors, delete authors

<img src="images/addauthors.png" alt="Authors Management">

# Add new categories, update categories, view categories, delete categories

<img src="images/addcategory.png" alt="Categories Management">

# Add new publishers, update publishers, view publishers, delete publishers

<img src="images/addpublisher.png" alt="Publishers Management">